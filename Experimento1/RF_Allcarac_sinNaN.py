...
# Calcular la media de la precisión, metricas y la matriz de consfusión tras el numero de intentos
accuracy_mean = np.mean(resultados_acurracy)
print("Accuracy media de los intentos:", accuracy_mean)
accuracy_round = np.round(accuracy_mean, 2)
print("Accuracy media de los intentos redondeada:", accuracy_round)
